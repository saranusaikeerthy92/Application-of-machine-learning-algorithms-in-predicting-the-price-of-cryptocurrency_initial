...
def pred():
    ...
    #xgbm_reg = pickle.load(open('XGB_10_10.dat', 'rb'))
    #xgbm_reg.load_model("model_5.json")
    xgbm_reg.load_model('model_23.bin')
    #xgbm_reg =  joblib.load("XGB_10_1.joblib.dat")
    ...
    today_btc_closing_price =  xgbm_reg.predict(X_scaled.values[-1].reshape(1,-1))
